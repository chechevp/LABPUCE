...
namespace LaboratorioPUCE.Core.Interfaces
{
    public interface IPrestamosService
    {
        ...
        Task<bool> SolicitarPrestamoBatchAsync(int usuarioId, List<(string nombreItem, int cantidad)> items, DateTime? fechaDevolucion = null);
        Task<bool> SolicitarDevolucionAsync(string codigoReserva, int usuarioId, string? evidenciaUrl = null, string? comentarioEstudiante = null);
        ...
        Task<bool> ActualizarEstadoSolicitudPorIdAsync(int prestamoId, string nuevoEstado, string? comentarioAdmin);
        ...
        Task<bool> MarcarComoDevueltoPorIdAsync(int prestamoId, string? comentarioAdmin, int cantidadDefectuosa = 0, string? evidenciaUrl = null);
        Task<bool> RechazarDevolucionAsync(string codigoReserva, string? comentarioAdmin, string? evidenciaUrl = null);
        Task<bool> RechazarDevolucionPorIdAsync(int prestamoId, string? comentarioAdmin, string? evidenciaUrl = null);
    }
}
